...
// RESOURCE ID PATTERN
HueBridge.validResourceID = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/gi;
        ...
        this.get = function (type, id = false, options = {}) {
            ...
            if (id) {
                ...
                if (scope.resources[id]) {
                    ...
                    if (type == "bridge") {
                        const message = new messages_1.HueBridgeMessage(targetResource, options);
                        // GET CURRENT STATE MESSAGE
                        let currentState = message.msg;
                        return currentState;
                    }
                    else if (type == "light") {
                        const message = new messages_1.HueLightMessage(targetResource, options);
                        ...
                        // GET MESSAGE
                        const message = new messages_1.HueGroupMessage(targetResource, { resources: scope.resources, ...options });
                        // GET & SAVE LAST STATE AND DIFFERENCES
                        let currentState = message.msg;
                        scope.lastStates[type + targetResource.id] = Object.assign({}, currentState);
                        currentState.updated = (lastState === false) ? {} : diff(lastState, currentState);
                        ...
                        const message = new messages_1.HueButtonsMessage(targetResource, options);
                        // GET & SAVE LAST STATE AND DIFFERENCES
                        let currentState = message.msg;
                        scope.lastStates[type + targetResource.id] = Object.assign({}, currentState);
                        currentState.updated = (lastState === false) ? {} : diff(lastState, currentState);
                        ...
                        const message = new messages_1.HueMotionMessage(targetResource, options);
                        // GET & SAVE LAST STATE AND DIFFERENCES
                        let currentState = message.msg;
                        scope.lastStates[type + targetResource.id] = Object.assign({}, currentState);
                        currentState.updated = (lastState === false) ? {} : diff(lastState, currentState);
                        ...
                        const message = new messages_1.HueTemperatureMessage(targetResource, options);
                        // GET & SAVE LAST STATE AND DIFFERENCES
                        let currentState = message.msg;
                        scope.lastStates[type + targetResource.id] = Object.assign({}, currentState);
                        currentState.updated = (lastState === false) ? {} : diff(lastState, currentState);
                        ...
                        const message = new messages_1.HueBrightnessMessage(targetResource, options);
                        // GET & SAVE LAST STATE AND DIFFERENCES
                        let currentState = message.msg;
                        scope.lastStates[type + targetResource.id] = Object.assign({}, currentState);
                        currentState.updated = (lastState === false) ? {} : diff(lastState, currentState);
                        ...
                        const message = new messages_1.HueRulesMessage(targetResource, options);
                        // GET & SAVE LAST STATE AND DIFFERENCES
                        let currentState = message.msg;
                        scope.lastStates[type + targetResource.id] = Object.assign({}, currentState);
                        currentState.updated = (lastState === false) ? {} : diff(lastState, currentState);
...
module.exports = function (RED) {
    RED.nodes.registerType("hue-bridge", function (config) {
